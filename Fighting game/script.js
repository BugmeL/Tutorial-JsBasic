...
let player1 = new Player('Time', 100, 15)
let player2 = new Player('Work', 100, 15)
...
document.addEventListener('keydown', function(e) {
  // if you press l AND the pla1yer health is greater than 0 AND isOver is still false then heal()
